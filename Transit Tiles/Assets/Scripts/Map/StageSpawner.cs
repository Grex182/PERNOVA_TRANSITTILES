...
public class StageSpawner : MonoBehaviour
{
    ...
    public void SpawnStageSection()
    {
        ...
        GameObject newStageSection = Instantiate(_stageSectionPrefab, 
                                                 new Vector3(stagePosition.x, spawnerStageSectionSpawnPoint.position.y, spawnerStageSectionSpawnPoint.position.z), 
        ...
        spawnerStageSectionSpawnPoint = newStageSection.GetComponent<StageSectionEnd>().GetNextSpawnPoint();
    }
    ...
    public void StartStage()
    {
        ...
        spawnerStageSectionSpawnPoint = startingStageSection.GetComponent<StageSectionEnd>().GetNextSpawnPoint();
